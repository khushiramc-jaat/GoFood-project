...
function Signup() {
    const[credentails,setCredentail]= useState({name:"",email:"",password:"",geolocation:""})
    ...
    <div className='container'>
        <form onSubmit={handleSubmit} >
            ...
            <div className="mb-3">
                ...
                <input type="text" className="form-control" name='geolocation' value={credentails.geolocation}  onChange={onChange} id="exampleInputAddress"/>
            </div>
